document.addEventListener("DOMContentLoaded", function () {
  ...
  function setEditMode(editing) {
    const formFields = document.querySelectorAll(
      "#manage-account-form input, #manage-account-form select"
    );
    ...
    document.getElementById("edit-button").style.display = editing
      ? "none"
      : "inline-block";
    document.getElementById("save-button").style.display = editing
      ? "inline-block"
      : "none";
    document.getElementById("discard-button").style.display = editing
      ? "inline-block"
      : "none";
