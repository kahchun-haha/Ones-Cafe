const categories = [
  ...
  { id: "5", icon: "bx bx-message", name: "Feedback", link: "/admin/viewFeedback" },
  { id: "6", icon: "bx bx-speaker", name: "Announcements", link: "/admin/announcements" },
...
function initSidebar() {
  ...
  categories.forEach(cat => {
    ...
    li.innerHTML = `<a href="${cat.link}" class="${isActive ? 'active' : ''}" id="${cat.id === '7' ? 'logout-link' : ''}"><i class="${cat.icon}"></i> ${cat.name}</a>`;
